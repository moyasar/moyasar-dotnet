...
namespace moyasar.MessagesMap
{
  public static class EnMessages
  {
        ...
        public const string SelectCreditCardType = "We Need CreditCard Info.";
        public const string CreatedCardNotReady = "CreatedCard Not Ready";
        public const string CreatedCardCompanyNotFound = "CreatedCard Company Required.";
